...
**各集侧栏标题（GitHub Pages）：** 主题词配置在 [[learning-notes/tv-series/modern-family/s02/episode-titles.yaml|episode-titles.yaml]]（与 transcript 场景索引一致）；MkDocs 构建时用于 `notes/*-daily-lines.md` 与 `transcript/*-transcript` 的导航显示名，**不必**批量改文件名。
