...
tags:
  ...
  - transcript
aliases:
  - WALL-E scene transcript
---

# WALL-E (2008) — Scene transcript

**Source:** [[learning-notes/tv-series/wall-e/wall-e.2008.en.srt|wall-e.2008.en.srt]]  
**Vocab:** [[learning-notes/tv-series/wall-e/vocabulary|vocabulary]] · **Index:** [[learning-notes/tv-series/wall-e/README|README]]

English-only scene script (timestamps removed). Segmented by plot beats in the style of Forrest Gump / Kung Fu Panda scenes. Sparse dialogue film; end-credits song cues after 'It's good to be home' omitted.

---

## Plot beats

### A. Earth trash — BNL ad

*WALL-E alone on garbage Earth; Buy N Large ads for the Axiom cruise.*
...
- **chart a course for non-stop entertainment, fine dining,**
- **and with our all-access hoverchairs, even Grandma can join the fun.**
...
### B. Directive — meet EVE

*EVE arrives; Classified directive; WALL-E introduces himself.*
...
### C. Axiom — humans on hoverchairs

*Buy N Large culture aboard; John, Mary; Captain summoned to the bridge.*
...
- **Feel beautiful.**
- **- It's the new you. Stunning. - You look great.**
...
### D. Probe positive — Operation Re-colonize

*Plant found; BNL message to return home; plant goes missing.*
...
- **Oh, I see the ship's log is showing that today is our 700th anniversary**
...
- **with a confirmed specimen of ongoing photosynthesis.**
...
- **by golly, we can begin "Operation Re-colonize".**
- **Simply follow this manual's instructions**
- **to place the plant in your ship's holo-detector**
...
### E. Define Earth — Define dancing

*Captain researches Earth; dancing; humans begin to wake up.*
...
- **- Hey, WALL-E! It's your buddy John. - Hi, WALL-E!**
- **Hi.**
- **Define: "hoedown".**
...
### F. Classified — Auto vs Captain

*Old directive A113; Auto mutiny; I don't want to survive, I want to live.*
...
- **- You know what? I should do it myself. - Captain.**
...
- **Give me the plant.**
- **- Tell me what's classified. - The plant.**
...
- **well, failed.**
- **Wouldn't you know, rising toxicity levels have made life**
- **unsustainable on Earth.**
- **"Unsustainable"? What?**
- **Darn it all, we're going to have to cancel "Operation Re-colonize".**
- **So,**
...
- **Caution. Rogue robots.**
- **Caution. Rogue robots.**
- **- Not possible. - Caution. Rogue robots.**
- **Auto! Auto!**
- **Mutiny. Mutiny.**
- **Stupid wheel.**
- **Caution. Rogue robots.**
...
- **Oh!**
- **Halt, halt.**
- **- Look what I got, Auto. - Not possible.**
- **That's right. The plant.**
- **You want it? Come and get it, blinky.**
- **No.**
- **Captain? Captain?**
- **Let go.**
- **- Let go. - Too heavy for you? Huh?**
- **Get off.**
