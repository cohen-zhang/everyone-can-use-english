...
tags:
  ...
  - transcript
aliases:
  - Matrix scene transcript
  - 黑客帝国场景剧本
---

# The Matrix (1999) — Scene transcript

**Source:** [[learning-notes/tv-series/the-matrix/the-matrix.1999.en.srt|the-matrix.1999.en.srt]]  
**Vocab:** [[learning-notes/tv-series/the-matrix/vocabulary|vocabulary]] · **Index:** [[learning-notes/tv-series/the-matrix/README|README]]

English-only scene script (timestamps removed). Segmented by plot beats in the style of Forrest Gump / Zootopia scenes. Light system tags kept when spoken as dialogue cues.

---

## Plot beats

### A. Trinity & Agents — cold open

*Phone tap; Trinity flees Agents; Neo woken by white rabbit.*
...
### B. Club & Trinity — What is the Matrix?

*Follow the white rabbit; Trinity names the question.*
...
### C. Mr. Anderson — office & Agents

*Boss lecture; Agents capture Neo; bug implant.*
...
*Morpheus; rabbit hole; Neo chooses the red pill.*
- **Welcome, Neo.**
...
### E. Real world — Construct

*Nebuchadnezzar; residual self-image; battery farms.*
...
### F. The One prophecy & training

*Oracle prophecy; I know kung fu; free your mind.*
...
### G. Agents & Cypher's deal

*Agents explained; Cypher wants the blue pill bliss.*
...
### H. The Oracle — there is no spoon

*Know thyself; Neo told he's not the One; choice foreshadowed.*
...
- **Was it the same cat?**
- **- I'm not sure. - Switch, Apoc.**
- **What is it?**

### I. Déjà vu & Cypher's betrayal

*Glitch; Morpheus captured; Cypher unplugs crew.*
...
- **Trinity.**
- **- Welcome to the real world. - But you're out, Cypher.**
...
- **I don't know.**
- **- This can't be just coincidence. - What?**
- **The Oracle.**
...
### J. Rescue — guns, lots of guns

*Neo & Trinity storm the building; Dodge this.*
- **Guns.**
- **Lots of guns.**
- **Neo...**
...
### K. Neo vs Agent Smith

*Subway fight; Neo dies and rises; he is the One.*
...
### L. Phone call — a world without rules

*Neo's vow; choice left to the viewer.*
