...
- 儿歌 *Down by the Station*（train / bus / taxi 等）— [[learning-notes/english-song/Celine/ClassicBooksWithHoles/DownByTheStation|Down by the Station — Classic Books with Holes]]
...
- **We wait behind the yellow line.** — 我们在黄线后面等。  
- **Let people get off first.** — 先让别人下车。  
- **Don’t run. The doors are closing.** — 别跑，门要关了。  
- **Mind the gap when you get on.** — 上车时注意脚下缝隙。

### 换乘与问路（可对工作人员说）

- **Excuse me, where is Line 2?** — 请问 2 号线怎么走？  
...
- 成人通勤一日流水（地铁约 50 分钟、共享单车）：[[learning-notes/personal-english-book/life/1分钟练习/一天.md|一天（1 分钟练习）]]
