...
**Apple Music：** [Take Me Back to London (feat. Stormzy)](https://music.apple.com/cn/song/take-me-back-to-london-feat-stormzy/1471580175)

**索引：** [[learning-notes/english-song/README|英文歌曲索引]]

**相关：** 思乡与归属感 — [[learning-notes/personal-english-book/life/emotions-adult-edition|情绪 — 成人版]]（*there ain't no place like home* 一类「回到自己人身边」的表达可对照本歌结尾）；同专辑拉丁风合作曲 [[learning-notes/english-song/south-of-the-border-ed-sheeran|South of the Border]]。

---

## 歌手简介 · About Ed Sheeran & Stormzy

**English**

**Ed Sheeran** (born 17 February 1991, Halifax, England) is a British **singer-songwriter** who moved to **London** in 2008 and built his career from small gigs and EPs, including the grime-heavy *No. 5 Collaborations Project* (2011). By 2019 he was a global stadium act with multiple Grammys; *No. 6 Collaborations Project* brought him back to the **UK rap / grime** world he came up in.

**Stormzy** (Michael Owuo Jr., born 26 July 1993, Croydon, South London) is a British **grime MC** and one of the UK's biggest rap stars. His 2017 debut *Gang Signs & Prayer* made history as the first grime album to reach **No. 1** on the UK Albums Chart; he headlined **Glastonbury** in 2019—the first solo black British artist to do so. Known for baritone flow, social commentary, and South London pride, he represents **grime** culture on a global stage while staying rooted in home.
...
**"Take Me Back to London"** was released on **12 July 2019** as a single from *No. 6 Collaborations Project*. Ed's hook is a **homecoming anthem**: jet planes, raves, bass-heavy nights—*take me back to London*. His verse admits the cost of fame (*grossed half a billi on the Divide tour*) and the pull of a simple pub night with mates. Stormzy's grime verses rep **South London** street culture—slang, status, and loyalty—while the closing section names **BRITs**, **Glastonbury**, and the line *there ain't no place like home*. The track topped the **UK Singles Chart** for five weeks. Notably, Stormzy turned down a planned **Jay-Z** feature because he felt the song should stay a London story.
...
| 曲风 | Genre | Pop · grime · UK hip-hop |
| 时长 | Length | 3:09 |
| 词曲 | Songwriters | Ed Sheeran, Stormzy, Fred Gibson, Johnny McDaid, Piers Aggett, Amir Amor |
...
| English | 简中 | 备注 |
| --- | --- | --- |
| **take me back to London** | 带我回伦敦 | 歌题核心；*take sb back to* = 把某人带回（某地/某段记忆） |
| **hit a rave** | 去锐舞派对 | *rave* = 电子舞曲派对；英国 youth culture 常用 |
| **chat shit** | 胡说八道；乱喷 | 英国俚语，极口语；含挑衅意味 |
| **get banged** | 挨揍；被收拾 | 街头俚语；*bang* = 打、开枪 |
| **let a 12 gauge rip** | 让 12 号霰弹枪响 | grime brag；*rip* = 开枪；*12 gauge* = 12 号霰弹 |
| **beef with grime neek** | 跟 grime 书呆子较劲 | *beef* = 过节；*neek* = 蹩脚货 |
| **the 'Gram** | Instagram | 口语缩略，带引号表平台名 |
| **online beef** | 网上骂战 | *beef* = 争执、过节（嘻哈常用） |
| **neek** | 书呆子；蹩脚货 | 英国 youth slang，略贬 |
| **G'd up** | 很硬；很有范儿 | 来自 *gangster*；表 street credibility |
| **leave you wet** | 让你湿透 | 双关：开枪/淋湿；grime 常见 brag |
| **the bits** | 街区；老地方 | 英国口语，= *the ends* / neighborhood |
| **packet of crisps** | 一包薯片 | 英式：*crisps*；美式 *chips* |
| **get off your high horse** | 别摆架子 | 习语：从「高头大马」下来 = 别装 |
| **never let 'em take your crown** | 别让人夺走你的王冠 | 保持地位与自我；*'em* = them |
| **half a billi** | 半个 billion（十亿） | 缩写 brag；指 Divide 巡演收入 |
| **when in Rome** | 入乡随俗 | 谚语 *When in Rome, do as the Romans do* 的截断 |
| **there ain't no place like home** | 没有地方比得上家 | 呼应《绿野仙踪》；思乡主题收束 |
| **made in Bow** | 在 Bow（伦敦）造出来的 | Bow 是 grime 发源地之一（East London） |
| **the way things go** | 事情就是这样 | *That's just the way things go* = 接受现实、没法改变 |
| **Vibranium** | 振金 | 漫威梗；Stormzy 比喻自己硬、耐打 |
| **supermalt** | 麦芽饮料 | 加勒比/英国街头常见饮品；grime 文化意象 |
| **Wembley** | 温布利球场 | 英国最大体育场；*ahead of time* = 提前到场 |
| **middle nights** | 深夜里 | 与 *bass high*、*ceilin' low* 一组，写 club 低音震天 |
| **want soul, want flows** | 要灵魂感，要 flow | Stormzy 段；*soul* 与商业化 fame 对照 |
| **wrappin' it up** | 收工；收尾 | 街头/说唱口语；*wrap it up* = 结束、搞定 |
...
- 想延伸练**思乡与归属**，可对照 [[learning-notes/personal-english-book/life/emotions-adult-edition|情绪 — 成人版]] 里关于 comfort / home 的表达；同专辑拉丁风曲目见 [[learning-notes/english-song/south-of-the-border-ed-sheeran|South of the Border]]。
