...
**"The Other"** by **LAUV** is a **国际流行** track from *I met you when I was 18. (the playlist)*. Themes in the lyrics often touch on **breakup loss, emotions, life attitude, love romance**, useful for spoken English and sing-along practice.

**中文**

**"The Other"**（**LAUV**）收录于 *I met you when I was 18. (the playlist)*，属 **国际流行** 风格。歌词主题多与 **分手·思念 · 情绪 · 生活态度 · 恋爱** 相关，适合跟唱与口语表达练习。

| 项目 | English | 信息 |
| --- | --- | --- |
| 专辑 | Album | *I met you when I was 18. (the playlist)* |
| 发行 | Release date | 2015-03-31 |
| 曲风 | Genre | Ballad · Pop |
| 时长 | Length | 3:09 |
| 播放列表 | Playlist | [English song](https://music.apple.com/cn/playlist/english-song/pl.u-JPAZEGNTD9ABPd1) · #50 |
...
| English | 简中 | 备注 |
| --- | --- | --- |
| *There's never been a way to make this easy* | 见歌词上下文 | 跟唱时可注意连读与重音 |
| *When there's nothing quite wrong but it don't feel right* | 见歌词上下文 | 含缩略 / 否定口语 |
| *I'm trying to forget* | 见歌词上下文 | 跟唱时可注意连读与重音 |
| *I'm caught in between* | 见歌词上下文 | 跟唱时可注意连读与重音 |
| *And I'll keep waiting like* | 见歌词上下文 | 跟唱时可注意连读与重音 |
| *Though I know that no one's listening* | 见歌词上下文 | 跟唱时可注意连读与重音 |
| *Back and forth now I'm feeling guilty* | 见歌词上下文 | 跟唱时可注意连读与重音 |
| *I nervously rehearse for when you're around* | 见歌词上下文 | 跟唱时可注意连读与重音 |
