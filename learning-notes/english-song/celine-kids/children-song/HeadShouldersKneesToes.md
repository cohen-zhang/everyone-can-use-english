...
| --- | --- | --- |
| 第 1 遍 | 全部七处都唱 | 完整版 |
| 第 2 遍 | 省略两句里的 **Head, shoulders, knees and toes** | 只唱 *Knees and toes* 与脸 |
| 第 3 遍 | 再省略 **And eyes and ears and mouth and nose** | 只剩 *Knees and toes* |
| 第 4 遍 | 常只反复 *Knees and toes*，越唱越快 | 膝盖和脚趾 |
...
**顺序记忆：** 从上到下（头→肩→膝→趾），再回到脸（眼→耳→口→鼻）。和 [[learning-notes/parenting-english/vocabulary/parenting-actions-vocab-extended-routines|亲子动作动词扩展]] 里 *Touch your nose.* / *Pat my shoulder.* 可配着玩。

---

## 单词表 · Word list

`亲子` 身体部位；跟唱时指着身体认读，不必一次背全表。

| English | IPA（美） | 词性 | 简中 | 歌词例句 |
| --- | --- | --- | --- | --- |
| **head** | /hed/ | n. | 头 | **Head**, shoulders, knees and toes |
| **shoulder** | /ˈʃoʊldər/ | n. | 肩膀 | Head, **shoulders**, knees and toes |
| **knee** | /niː/ | n. | 膝盖 | Head, shoulders, **knees** and toes |
| **toe** | /toʊ/ | n. | 脚趾 | knees and **toes** |
| **eye** | /aɪ/ | n. | 眼睛 | **eyes** and ears |
| **ear** | /ɪr/ | n. | 耳朵 | eyes and **ears** |
| **mouth** | /maʊθ/ | n. | 嘴巴 | mouth and nose |
| **nose** | /noʊz/ | n. | 鼻子 | mouth and **nose** |
| **and** | /ænd/ | conj. | 和；以及 | knees **and** toes |

**复数：** 歌词里 **shoulders, knees, toes, eyes, ears** 用复数（身体两侧或成对部位）。

---

## 单复数说明 · Singular & plural

| 单数 | 复数（歌词） | 简中 |
| --- | --- | --- |
| shoulder | **shoulders** | 双肩 |
| knee | **knees** | 双膝 |
| toe | **toes** | 双脚趾 |
| eye | **eyes** | 双眼 |
| ear | **ears** | 双耳 |

**head / mouth / nose** 在歌里用**单数**（一个头、一张嘴、一个鼻子）。

---

## 认读小练习 · Body-part drill

唱完一节，快速问答：

| 问 | 答 |
| --- | --- |
| Touch your head! | （摸头）**Head!** |
| Where are your shoulders? | **Here!**（拍肩） |
| Knees and…? | **Toes!** |
| Eyes and ears and…? | **Mouth and nose!** |
| What's on your face? | **Eyes, ears, mouth, nose.** |

**进阶：** 倒着说 — *Toes, knees, shoulders, head!* 练反向记忆。
