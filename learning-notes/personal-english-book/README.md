...
- **音标输入 ↔ 速查 ↔ 音节重音：** [[learning-notes/pronunciation/phonetics-input-guide|音标输入指南]] ↔ [[learning-notes/pronunciation/phonetics-engineer-quick-reference|音标工程师速查]] ↔ [[learning-notes/pronunciation/syllable-division-ipa-based|音节划分与重音 · IPA]]（见 [[learning-notes/pronunciation/README|发音资料索引]]）。
