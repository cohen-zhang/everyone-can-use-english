...
1. 这篇文章包含了很多我们容易读错的英语单词
2. 包含了很多英语口语中的连读、弱读等等
3. 通过练习易读错的单词来纠正音标从而触类旁通
...
- 首段约 **66** 个英文词，适合整段朗读练节奏与连读。

### 单词与重音（IPA：通用英式，括号内为常见美式差异）

| 词 | IPA | 提示 |
| --- | --- | --- |
| cinema | /ˈsɪnəmə/ | 三音节，重音在第一音节；勿读成「辛呐马」拖长尾音。 |
| before | /bɪˈfɔː(r)/ | 两拍：be- **fore**，fore 有长度；勿吞掉 /r/（美式）。 |
| twentieth | /ˈtwentiəθ/ | 注意 **/n/** 的鼻音与 **-tieth** 连贯；勿漏读中间音节。 |
| century | /ˈsentʃəri/ | **cen-** 重读；末尾常弱读为 /əri/。 |
| moving | /ˈmuːvɪŋ/ | **-ing** 为 /ɪŋ/，舌后部抵软腭。 |
| pictures | /ˈpɪktʃəz/ | **pic-** 与 **-tures** 之间可略有「气口」，像乐句中的短休止，避免糊成一拍。 |
| kid / pig | /kɪd/ · /pɪɡ/ | 均为 **短元音 /ɪ/**，勿读成汉语「衣」的长音。 |
| a man | /ə ˈmæn/ | **a** 弱读 /ə/；**man** 重读。 |
| house（单数） | /haʊs/ | 双元音 **/aʊ/**：从 **ɑ** 滑向 **ʊ**，像「哈→乌」一气呵成。 |
| houses（复数） | /ˈhaʊzɪz/ | 复数常加音节 **/zɪz/**，与单数节奏不同。 |
| casual | /ˈkæʒuəl/ | 重音在首音节；**-sual** 含 /ʒ/（类似「日」的摩擦感）。 |
| usually | /ˈjuːʒuəli/ | 常见 **/ʒ/**（与 casual 同属一类音）；口语中常弱化为两拍。 |
| extremely | /ɪkˈstriːmli/ | 重音在 **-treme-**；前缀 **ex-** 在此多读 /ɪks-/。 |
| nervous | /ˈnɜːvəs/ | **-ous** 读作 /əs/，**无 /r/ 卷舌**（英式）；美式带儿化时才是 /ˈnɜːrvəs/。 |
| anxious | /ˈæŋkʃəs/ | 同上，**-ous → /əs/**；重音在首音节。 |
| famous | /ˈfeɪməs/ | **-ous** 仍是弱读 /əs/，不要卷成「儿化 famous」。 |
| documentary | /ˌdɒkjʊˈmentri/ 等 | 多音节词，注意次重音与主重音分配（词典跟读）。 |
| commercial | /kəˈmɜːʃl/ | **-mer-** 重读。 |
| entertainment | /ˌentəˈteɪnmənt/ | 长词，先分段再连读。 |

### 最小对立与易混

| 对比 | IPA | 说明 |
| --- | --- | --- |
| **then** vs **than** | /ðen/ vs /ðæn/ | 元音 **/e/** 与 **/æ/**；**then** 表「那时、然后」，**than** 表比较。 |
| **idea** vs **dear** | /aɪˈdɪə/ vs /dɪə(r)/ | **idea** 三音节、有 /aɪ/ 与词尾 /ə/；**dear** 单音节（或美式带 /r/）。 |

### 连读与语流

| 片段 | 读法提示 |
| --- | --- |
| **with a** | /wɪðə/ 或 /wɪθə/：**th** 与 **a** 自然拼成「维惹」式一连，**a** 弱读。 |
| **an egg** | /ən eɡ/：**n** 与元音连读；**egg** 重读。 |
| **or even** | /ɔːr ˈiːvn/（美式带 /r/）：**or** 弱、**e-** 起小高潮，整句更顺。 |

### s 后爆破音（教材常称「清辅音浊化」）

在 **/s/** 后面的 **/p, t, k/** 常**不送气**（与汉语「波、德、哥」更接近），并非真变成 b、d、g：

- **sky** /skaɪ/ · **study** /ˈstʌdi/ · **stupid** /ˈstjuːpɪd/ · **expressing** /ɪkˈspresɪŋ/

听感上像「更紧的 t/k」，跟读时用同一类口型带过即可。
...
| --- | --- | --- |
| 名词 | **/ˈkɒntent/** | 内容、目录 |
| 形容词 | **/kənˈtent/** | 满足的（表语常见） |
| 动词 | **/kənˈtent/** | 使满足 |

朗读时：**名词**重音在 **con-**；**形容词 / 动词**重音多在第二音节 **-tent**（以词典音频为准）。

---

*提示：易混处多听英式 / 美式各一遍，固定自己的主口音后再细抠细节。*
